...
public class AllyAttack : MonoBehaviour
{
    ...
    public AllyProjectile projectilePrefab;
    ...
    private void FixedUpdate()
    {
        ...
        if (aggroColliders.Length > 0)
        {
            ...
            transform.gameObject.GetComponent<AllyMovement>().isChasing = true;
        ...
        {
            transform.gameObject.GetComponent<AllyMovement>().isChasing = false;
        }
    }
